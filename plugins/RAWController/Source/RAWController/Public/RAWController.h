...
class IRAWControllerInput : public IInputDevice
{
public:
	IRAWControllerInput(const TSharedRef<FGenericApplicationMessageHandler>& InMessageHandler);

	virtual ~IRAWControllerInput() {}
...
// This is the container for the input device plugin
